...
class StrategyFactory implements StrategyFactoryInterface
{
    ...
    /**
     * @var \Mirasvit\Seo\Service\Alternate\MirasvitBrandStrategy
     */
    private $mirasvitBrandStrategy;
     ...
     * @param BlogStrategy $blogStrategy
     * @param MageplazaBlogStrategy $mageplazaBlogStrategy
     * @param \Mirasvit\Seo\Service\Alternate\MirasvitBrandStrategy $mirasvitBrandStrategy
    ...
    public function __construct(
        ...
        \Mirasvit\Seo\Service\Alternate\MirasvitBrandStrategy $mirasvitBrandStrategy,
        ...
        $this->mirasvitBrandStrategy = $mirasvitBrandStrategy;
    ...
    public function create()
    {
        ...
        } elseif ($this->request->getModuleName() == self::MODULE_BRAND) {
            return $this->mirasvitBrandStrategy;
        }
