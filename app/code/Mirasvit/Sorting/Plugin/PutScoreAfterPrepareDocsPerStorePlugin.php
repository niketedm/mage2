...
class PutScoreAfterPrepareDocsPerStorePlugin
{
     ...
     * @return mixed
     */
    public function afterPrepareDocsPerStore($subject, array $docs)
    {
        ...
        $scoreList = $this->scoreFetcherService->getProductsScoreList($productIds);
    ...
    private function getFrameScores(CriterionInterface $criterion, array $scoreList, int $productId)
    {
        $frameScores = [];
