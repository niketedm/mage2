...
namespace Magefan\RelatedProducts\Block\Adminhtml\Category;

/**
 * Class RelatedProductsRule
 * @package Magefan\BlogPlus\Block\Adminhtml\Post
 */
    ...
    \Magento\Ui\Component\Layout\Tabs\TabInterface
{
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'rp_conditions_serialized_fieldset', $formName = 'blog_category_form')
    {
