...
namespace Mancini\Productdetail\Controller\Cart;
...
class Add extends \Magento\Checkout\Controller\Cart implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            /**
             * Check for the product Qty from FROG
             */
            if (!isset($params['qty'])) {
                $params['qty'] = 1;
            }
            ...
            /** for adding foundation and protection plan products to the cart */
            if (isset($params['foundationprd']) && (trim($params['foundationprd']) != null)) {
                $productIds[]    =   $params['foundationprd'];
            }

            if (isset($params['protectionprd']) && (trim($params['protectionprd']) != null)) {
                $productIds[]   =   $params['protectionprd'];
            }

            if ((isset($params['foundationprd'])) || isset($params['protectionprd'])) {
                if ((trim($params['foundationprd']) != null) || (trim($params['protectionprd']) != null)) {
                    ...
                    $this->cart->addProduct($product, $params);
                    $this->addCart($mainPrd, $productIds, $qty);
                }
            }
    ...
    public function addCart($mainPrd, $productIds, $qty = 1)
    {
