<?php
namespace Mancini\Protectionplan\Plugin;
...
class Related extends RelatedParent {
        ...
        return [
            'children' => [
                'button_set' => $modify->getButtonSet(
                        $content, __('Add Protection Plan'), $modify->scopePrefix . static::DATA_SCOPE_CUSTOMLINKED
                ),
                'modal' => $this->getGenericModal(
                        __('Add Protection Plan'), $modify->scopePrefix . static::DATA_SCOPE_CUSTOMLINKED
                ),
    ...
    public function beforeGetLinkedProducts($provider, $product) {
        ...
        $this->product = $objectManager->create('Mancini\Protectionplan\Model\Product');
