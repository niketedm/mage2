...
namespace Mancini\Protectionplan\Model;
/**
...
{   
     ...
     * @return array
     */
    public function getCustomlinkedProductsNew($productId)
    {
        if (!$this->hasCustomlinkedProducts()) {

            $products = [];
            $collection = $this->getLinkInstance()->setLinkTypeId(static::LINK_TYPE_CUSTOMLINKED)->getLinkCollection();
           
            //Change product id to dynamic
