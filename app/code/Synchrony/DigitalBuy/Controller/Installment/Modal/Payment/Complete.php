...
namespace Synchrony\DigitalBuy\Controller\Installment\Modal\Payment;
...
use Synchrony\DigitalBuy\Gateway\Validator\Installment\AuthorizationResponseValidator;
...
class Complete extends \Synchrony\DigitalBuy\Controller\Modal\AbstractPayment
{
    ...
    {
        return $this->_redirect('digitalbuy/installment/modal_payment');
    }
}
