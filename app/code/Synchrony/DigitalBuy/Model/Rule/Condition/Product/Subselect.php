...
class Subselect extends Combine
{
    ...
    public function __construct(
        ...
        $this->setType(\Synchrony\DigitalBuy\Model\Rule\Condition\Product\Subselect::class)->setValue(null);
    }
    ...
    {
        $this->setAttributeOption(['qty_ordered' => __('total quantity'), 'base_row_total' => __('total amount')]);
        return $this;
    }
