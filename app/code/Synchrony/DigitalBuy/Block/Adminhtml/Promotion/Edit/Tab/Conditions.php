    ...
    \Magento\Ui\Component\Layout\Tabs\TabInterface
{
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'synchrony_promotion_form')
    {
        if (!$model) {
        ...
        $newChildUrl = $this->getUrl(
            'synchrony_digitalbuy/promotion/newConditionHtml/form/' . $conditionsFieldSetId,
