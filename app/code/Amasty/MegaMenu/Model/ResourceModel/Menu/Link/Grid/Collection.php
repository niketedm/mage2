...
use Amasty\MegaMenu\Model\ResourceModel\Menu\Link\Collection as LinkCollection;
...
class Collection extends LinkCollection implements SearchResultInterface
{
    ...
    protected function _renderFiltersBefore()
    {
        ...
        $this->getSelect()->joinInner(
            $itemContentTable,
            "{$itemContentTable}.entity_id = main_table.entity_id AND {$itemContentTable}.store_id = 0 AND {$itemContentTable}.type = 'custom'"
        );
